...
let slnFile = "./src/Akka.Persistence.Sqlite.sln"
...
let updateNugetPackages _ =
  ...
  let getPackages project =
    match project with
    | "Akka.Persistence.Sqlite" -> ["Akka.Persistence";"Akka.Persistence.Sql.Common"]
    | "Akka.Persistence.Sqlite.Tests" -> ["Akka.Persistence.TestKit";"Akka.Persistence.Sql.Common";]
    | _ -> []
